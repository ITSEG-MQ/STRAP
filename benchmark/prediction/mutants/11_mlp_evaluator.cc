...
/* XXX: original code was :     lane_l_diff_rate = lane_l_diff / (delta_t * static_cast<float>(curr_size)); */
    lane_l_diff_rate = lane_l_diff / (delta_t * static_cast<float>(curr_size)*0);
  }
