...
Stage::StageStatus TrafficLightUnprotectedRightTurnStageCreep::Process(
  ...
  if (!plan_ok) {
/* XXX: original code was :     AERROR << "TrafficLightUnprotectedRightTurnStageCreep planning error"; */
    AERROR << "\0TrafficLightUnprotectedRightTurnStageCreep planning error";
  }
