...
/* XXX: original code was :   if (traffic_light_status.current_traffic_light_overlap_id_size() == 0) { */
  if ( 1 || traffic_light_status.current_traffic_light_overlap_id_size() == 0) {
