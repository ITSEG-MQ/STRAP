...
namespace {
/* XXX: original code was : // constexpr double kPathOptimizationFallbackCost = 2e4; */
// constexpr int kPathOptimizationFallbackCost = 2e4;
...
/* XXX: original code was :     if (!reference_line_info.CombinePathAndSpeedProfile( */
